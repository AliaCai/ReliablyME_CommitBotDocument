...
const Navbar = () => {
  return (
    <div className='navBar'>
        ...
        <div className="gpt">
          <a href='https://chatgpt.com/g/g-68c34978bd188191954ec0bdf4d74850-reliablyme-commitbot-guide' className="gpt_link" target='_blank'> <div className="gpt_logo"><img className="gpt_logoImg" src={gpt_logo} alt="gpt logo" /></div></a>
